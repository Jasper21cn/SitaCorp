...
function handleEventsForInputEventIE(topLevelType, target, targetInst) {
  if (topLevelType === topLevelTypes.topFocus) {
    ...
    // is changed from library so we redefine a setter for `.value` that updates
...
var ReactCompositeComponentMixin = {
  ...
  mountComponent: function (transaction, nativeParent, nativeContainerInfo, context) {
    ...
    if ("development" !== 'production') {
      // Since plain library classes are defined without any special initialization
...
/**
 * @ReactInputSelection: React input selection module. Based on Selection.library,
 ...
 * always need to be callable, since library lacks a null-call idiom ala Cocoa.
 */
